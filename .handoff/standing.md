...
- Por solicitação explícita do mantenedor em 2026-09-03, preservar a opção oculta `4` (`Ati`) do menu de ativação, inclusive o download confirmado do Microsoft Activation Scripts. Esta é uma exceção específica e não reabre pontes genéricas para execução remota.
